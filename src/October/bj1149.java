...
// 빨강, 초록, 파랑으로 칠하는 비용을 각각 저장하는 배열을 생성합니다. 예를 들어, r[i], g[i], b[i]는 i번째 집을 빨강, 초록, 파랑으로 칠하는 비용을 나타내는 배열입니다.
//
//다이나믹 프로그래밍을 위한 배열을 초기화합니다. 여기서 dp[i][j]는 i번째 집까지 칠하고, i번째 집의 색이 j(0: 빨강, 1: 초록, 2: 파랑)일 때의 최소 비용을 나타내는 배열입니다.
//
